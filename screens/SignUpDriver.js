    ...
    onAuthComplete(props){
        if(props.token){
            const resetAction = StackActions.reset({
                ...
                key: null,
                actions: [
                     NavigationActions.navigate({ routeName: 'DriverHome' })
                ],
           });
        ...
        <View style={styles.container}>
            <View style={styles.insidecontainer}>
               ...
               {this.renderButton()}
                ...
                <Text style={{marginTop:50,fontSize:20}} >Already have an account? <Text style={{fontSize:23,color:'blue',textDecorationLine:'underline'}} onPress={() => this.props.navigation.navigate('AuthScreenDriver')}>Sign In</Text></Text> 
